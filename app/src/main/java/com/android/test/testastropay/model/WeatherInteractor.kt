...
class WeatherInteractor {
    ...
    fun getWeatherRemoteDataFromCity(cityName: String): Observable<WeatherData> {
    ...
    fun getWeatherRemoteDataFromLatLon(latitude: Double, longitude: Double): Observable<WeatherListData> {
